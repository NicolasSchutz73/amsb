...
@php
    $classes = ($active ?? false)
                ? 'bg-black block w-full ps-3 pe-4 py-2 border-l-4 border-red-500 text-start text-base font-medium text-red-500 focus:outline-none focus:text-red-600 focus:bg-red-100 focus:border-red-600 transition duration-150 ease-in-out'
